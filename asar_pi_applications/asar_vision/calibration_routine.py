...
purple = "purple"
black = "black"
im = cv2.imread('robot_terrain.jpg')
print('First start by clicking on a red tile\n')
print('proceed to click on a blue tile\n then green...\n gray\n purple(victim)\n yellow\n orange\n black \n pink(robot)')
parameters['color'] = [red, blue, green, gray, purple, yellow, orange, black, pink]
...
print('click four corners in clockwise rotation beginning with top left')
